...
/**
 * Criteria class for the {@link mx.com.tordavi.domain.CDetalleReservacion} entity. This class is used
 * in {@link mx.com.tordavi.web.rest.CDetalleReservacionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /c-detalle-reservacions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class CDetalleReservacionCriteria implements Serializable, Criteria {
    ...
    public CDetalleReservacionCriteria() {
    }

    public CDetalleReservacionCriteria(CDetalleReservacionCriteria other) {
    ...
    @Override
    public CDetalleReservacionCriteria copy() {
        return new CDetalleReservacionCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CDetalleReservacionCriteria that = (CDetalleReservacionCriteria) o;
        return
    ...
    public String toString() {
        return "CDetalleReservacionCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
