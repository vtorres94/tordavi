...
export const CCliente = (props: ICClienteProps) => {
  ...
  return (
    <div>
      <h2 id="c-cliente-heading">
        <Translate contentKey="tordaviApp.cCliente.home.title">C Clientes</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="tordaviApp.cCliente.home.createLabel">Create new C Cliente</Translate>
        </Link>
      </h2>
        ...
        {cClienteList && cClienteList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('claveCliente')}>
                  <Translate contentKey="tordaviApp.cCliente.claveCliente">Clave Cliente</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('cliente')}>
                  <Translate contentKey="tordaviApp.cCliente.cliente">Cliente</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('logo')}>
                  <Translate contentKey="tordaviApp.cCliente.logo">Logo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('fechaCreacion')}>
                  <Translate contentKey="tordaviApp.cCliente.fechaCreacion">Fecha Creacion</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('notas')}>
                  <Translate contentKey="tordaviApp.cCliente.notas">Notas</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('estatus')}>
                  <Translate contentKey="tordaviApp.cCliente.estatus">Estatus</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('borrado')}>
                  <Translate contentKey="tordaviApp.cCliente.borrado">Borrado</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {cClienteList.map((cCliente, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <TextFormat type="date" value={cCliente.fechaCreacion} format={APP_DATE_FORMAT} />
                  </td>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`${match.url}/${cCliente.id}`} color="info" size="sm">
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="tordaviApp.cCliente.home.notFound">No C Clientes found</Translate>
            </div>
          )
        )}
      </div>
