...
export const CClienteDeleteDialog = (props: ICClienteDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="tordaviApp.cCliente.delete.question">
        <Translate contentKey="tordaviApp.cCliente.delete.question" interpolate={{ id: cClienteEntity.id }}>
          Are you sure you want to delete this CCliente?
        </Translate>
      </ModalBody>
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-cCliente" color="danger" onClick={confirmDelete}>
